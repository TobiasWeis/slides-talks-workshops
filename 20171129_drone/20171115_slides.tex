...
\begin{frame}{Hardware and stuff}
	\begin{itemize}
		\item Hardware used: NVIDIA GTX 1080 Ti, i7-7700K @ 4.2Ghz
		\item Framerate achieved: 10fps
...
\begin{frame}{Assessment}
	\begin{itemize}
		\item Today not feasible
		\item Limited flight time - if specific targets, need a GPS-fix or something beforehand
		\item Drone cannot "loiter" to wait for a target to get out of a building
		\item Far too expensive for "everyday" use
	\end{itemize}
\end{frame}
